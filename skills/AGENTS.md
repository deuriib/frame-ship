...
- Stage file counts: `quality-gate` 15+ files; `translate-to-spec` 4; all others 3 (SKILL + 2 refs). Templates live in `agents/` outside stage counts (`skills/templates/` removed).
