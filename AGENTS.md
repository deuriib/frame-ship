...
└── skills/             # 12 process skills (bootstrap using-frame-ship + 9 chain stages + 2 supporting)
```
...
## NOTES
- Version lockstep: [frame-ship v0.12.0] — bump with `plugins/opencode/shared.ts` + `plugins/antigravity/hooks/context-inject.ts`.
