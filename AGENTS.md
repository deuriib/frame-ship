...
└── package.json  # v0.4.0 (matches plugin header)
```
...
- Version aligned: root `package.json` v0.4.0 matches plugin header `v0.4.0` — bump header comment + `VERSION` + `MARKER` + manifest together on next release.
